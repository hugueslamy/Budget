...
class AllocationsControllerTest < ActionController::TestCase
  ...
  test "should create allocation" do
    assert_difference('Allocation.count') do
      post :create, allocation: { account_id: @allocation.account_id, effective_date: @allocation.effective_date, note: @allocation.note, value: @allocation.value }
    end
  ...
  test "should update allocation" do
    put :update, id: @allocation, allocation: { account_id: @allocation.account_id, effective_date: @allocation.effective_date, note: @allocation.note, value: @allocation.value }
    assert_redirected_to allocation_path(assigns(:allocation))
  end
